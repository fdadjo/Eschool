...
import com.software.zone.pro.eschool.service.util.RandomUtil;
...
public class UserService {
    ...
    public User createUser(String login, String password, String firstName, String lastName, String email,
                           String langKey,String[] authoritiesConstantses) {
        ...
        for (String authoritiesConstants: authoritiesConstantses ) {
            Authority authority = authorityRepository.findByName(authoritiesConstants);
            authorities.add(authority);
        }

        newUser.setAuthorities(authorities);
        User ser = userRepository.save(newUser);
        log.debug("Created Information for User: {}", newUser);
        return ser;
    }
