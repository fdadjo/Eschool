...
import com.software.zone.pro.eschool.domain.Message;
import com.software.zone.pro.eschool.repository.MessageRepository;
...
public class MessageResourceIntTest {
    ...
    private static final MessageType DEFAULT_TYPE = MessageType.COMMA;
    private static final MessageType UPDATED_TYPE = MessageType.COMMA;
    ...
    public void createMessage() throws Exception {
        ...
        assertThat(testMessage.getContentType()).isEqualTo(DEFAULT_CONTENT_TYPE);
    ...
    public void updateMessage() throws Exception {
        ...
        assertThat(testMessage.getContentType()).isEqualTo(UPDATED_CONTENT_TYPE);
