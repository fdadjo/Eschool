...
import com.software.zone.pro.eschool.repository.PaymentRepository;
...
public class PaymentResourceIntTest {
    ...
    private static final PaymentType DEFAULT_TYPE = PaymentType.COMMA;
    private static final PaymentType UPDATED_TYPE = PaymentType.COMMA;
