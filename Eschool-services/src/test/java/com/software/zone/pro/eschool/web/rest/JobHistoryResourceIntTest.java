...
import com.software.zone.pro.eschool.domain.JobHistory;
import com.software.zone.pro.eschool.repository.JobHistoryRepository;
...
public class JobHistoryResourceIntTest {
    ...
    public void createJobHistory() throws Exception {
        ...
        assertThat(testJobHistory.getMonthlySalary()).isEqualTo(DEFAULT_MONTHLY_SALARY);
    }
    ...
    public void updateJobHistory() throws Exception {
        ...
        JobHistory testJobHistory = jobHistoryList.get(jobHistoryList.size() - 1);
        assertThat(testJobHistory.getMonthlySalary()).isEqualTo(UPDATED_MONTHLY_SALARY);
    }
